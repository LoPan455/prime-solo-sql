...
SELECT "city","username" FROM "syntax_practice" WHERE "city" = 'chicago' LIMIT 100;
...
SELECT * FROM "syntax_practice" WHERE "account_balance" = 0 AND "transactions_attempted" = 0; /* runs the check */
...
VALUES ('tom', 'Minneapolis', '12', '15', '6453');
